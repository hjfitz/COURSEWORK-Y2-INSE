...
public class Main extends JFrame {
	...
	public Main() {
		...
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] { "Locks Way Road", "Lidl", "Fratton Station",
				"Cambridge Road", "Winston Churchill Ave", "gowno" }));
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (departing) {
						...
						System.out.println(
								(timeDiff / 3600000) + " hours and " + (timeDiff % 3600000) / 60000 + " minutes");
					...
					for (int i = 0; i < toStop.size(); i++) {
						// System.out.println(fromStop.get(i).getTime() +
						// fromStop.get(i).getBusName());
						// System.out.println(toStop.get(i).getTime() +
		...
		btn_font.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				JComponent elementList[] = { lblHints, lblSearchForA, lblTo, comboBox, lblArriveAt, comboBox_1,
						comboBox_2, txtTime, btnNewButton, lblMostPopularRoutes };
		...
		table.setModel(
				new DefaultTableModel(new Object[][] { { null, null }, }, new String[] { "Route Name", "Time" }));
